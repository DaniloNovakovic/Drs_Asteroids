...
class Multi(QMainWindow):
    ...
    def chooseShip(self):
        ...
        self.player1Cb.setStyleSheet("border:1px solid rgb(220, 20, 60);font-size: 20px; color: red; font-family: Helvetica;");
        ...
        # self.player1Cb.setCursor(Qt.PointingHandCursor)
        self.player2Cb.setStyleSheet("border:1px solid rgb(220, 20, 60);font-size: 20px; color: red; font-family: Helvetica;");
        self.player2Cb.addItem("")
        self.player2Cb.addItem("Space1")
        self.player2Cb.addItem("Space2")
